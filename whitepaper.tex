...
applications. zeppelinOS is an open-source, distributed
...
% \toprule
%   \textbf{Section} & \textbf{Actors and token usage}\tabularnewline
% \midrule
% \endhead
% \textbf{zeppelinOS Kernel} & 
...
% \textbf{Scheduling} &
% \textbf{People in need of async execution}: issue ZEP token bounties.
%
...
% tokens.
% \tabularnewline\midrule
% \textbf{State Channel Support} & \emph{No token required.}
% \tabularnewline\midrule
% \textbf{Off-Chain Tools} & Users can pay in ZEP or any other token.\tabularnewline
% \bottomrule
% \end{longtable}

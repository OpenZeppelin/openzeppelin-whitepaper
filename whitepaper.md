...
proxy library pattern [\[2\]][proxylibs] developed in joint
...
OpenZeppelin [\[3\]][openzeppelin], and held to the same security
standards.
...
larger [\[4\]][schneier], and with it comes a greater possibility of attack.
...
Figure 3: ZEP in relation to zeppelin\_os stack.
...
State Channels [\[5\]][statechan] being one of the latest proposals for
...
conducted by the Zeppelin Solutions [\[6\]][zeppelinsolutions] team,
...
the controlling party to exert non-competitive influence [\[7\]][apple]
...
## Heroku [\[8\]][heroku] for Decentralized applications
...
building blocks. Like IFTTT [\[9\]][ifttt] recipes for smart contracts.
